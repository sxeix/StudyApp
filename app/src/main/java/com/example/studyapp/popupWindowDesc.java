...
public class popupWindowDesc extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title = findViewById(R.id.desc_name); title.setText(event.getName());
        TextView loc = findViewById(R.id.desc_loc); loc.setText(getResources().getString(R.string.location_input) + ": " + event.getLocation());
        TextView date = findViewById(R.id.desc_date); date.setText(getResources().getString(R.string.start_date) + " " + routineCheck(event));
        TextView start_time = findViewById(R.id.desc_start); start_time.setText(getResources().getString(R.string.start_time) + ": " + dailyCheck(event, 0));
        TextView end_time = findViewById(R.id.desc_end); end_time.setText(getResources().getString(R.string.end_time) + ": " + dailyCheck(event, 1));
        TextView type = findViewById(R.id.desc_type); type.setText(getResources().getString(R.string.event_type) + ": " + returnFreqString(event));
    }
